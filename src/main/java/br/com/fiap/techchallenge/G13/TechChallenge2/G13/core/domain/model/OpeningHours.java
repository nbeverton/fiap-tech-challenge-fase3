...
public class OpeningHours {
    ...
    public OpeningHours(String opens, String closes) {
        if (opens == null || opens.isBlank()) throw new IllegalArgumentException("opens must not be blank");
        if (closes == null || closes.isBlank()) throw new IllegalArgumentException("closes must not be blank");
        this.opens = opens;
        this.closes = closes;
    }
